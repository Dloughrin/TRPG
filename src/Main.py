...
def main_menu(screen):
    ...
    while running:
        ...
        draw_text('Set Characters', font, (255, 255, 255), screen, w-buttonSize/2, buttonStart+buttonOffset*2)
        draw_text('Options', font, (255, 255, 255), screen, w-buttonSize/2, buttonStart+buttonOffset*3)
        draw_text('Quit Game', font, (255, 255, 255), screen, w-buttonSize/2, buttonStart+buttonOffset*4)
